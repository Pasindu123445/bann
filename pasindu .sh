...
#
# Termux Banner
# Banner by CYBER KING(PASINDU)
# _____Do Not Copy Or Modify, Otherwise I will sue you copyright_____
#
#
clear
figlet -f big HYDRA_BY_VIRORI | lolcat
cyan='\e[0;36m'
lightgreen='\e[1;32m'
red='\e[1;31m'
yellow='\e[1;33m'
echo -e $lightgreen "\e[1m _____________________ HYDRA_BY_VIRORI "
echo " "
echo -e $yellow "\e[1m _____________________________________________________________________________________ "
echo " "
echo " "
echo " "
